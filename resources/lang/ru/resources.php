...
return [
        ...
        'table' => [
            ...
            'actions' => [
                ...
                'delete' => [
                    ...
                    'description' => 'Удаление подключения навсегда очистит все связанные данные Jibble. Это действие невозможно отменить.',
                    'confirm' => 'Удалить подключение',
                    'cancel' => 'Отмена',
                ],
                'delete_bulk' => [
                    'heading' => 'Удалить выбранные подключения?',
                    'description' => 'Удаление выбранных подключений навсегда очистит все связанные данные Jibble. Это действие невозможно отменить.',
                    'confirm' => 'Удалить подключения',
                    'cancel' => 'Отмена',
                ],
            ],
        ],
    ...
    'people' => [
        ...
        'fields' => [
            ...
            'pay_period_definition_id' => 'ID расчётного периода',
            'work_start_date' => 'Дата начала работы',
            'join_date' => 'Дата присоединения',
            'latest_time_entry_time' => 'Последняя отметка времени',
            'invited_at' => 'Приглашение отправлено',
            'removed_at' => 'Удалён',
            'jibble_created_at' => 'Создано в Jibble',
            'jibble_updated_at' => 'Обновлено в Jibble',
            'overridden_properties' => 'Переопределённые поля',
            'projects' => 'Проекты',
            'work_types' => 'Типы работ',
            'managers' => 'Менеджеры',
            'unit_time_off_policies' => 'Политики отпусков',
            'picture' => 'Фото',
            'managed_units' => 'Управляемые подразделения',
            'kiosks' => 'Киоски',
        ...
        'table' => [
            'columns' => [
                ...
                'latest_time_entry_time' => 'Последняя отметка',
                'has_embeddings' => 'Эмбеддинги',
                'created_at' => 'Создано',
            ],
            'filters' => [
            ...
            'actions' => [
                'delete' => [
                    'heading' => 'Удалить пользователя Jibble?',
                    'description' => 'При удалении пользователя будут удалены все его записи в базе данных. Вы уверены, что хотите продолжить?',
                    'confirm' => 'Удалить пользователя',
                    'cancel' => 'Отмена',
                ],
                'delete_bulk' => [
                    'heading' => 'Удалить выбранных пользователей?',
                    'description' => 'При удалении выбранных пользователей будут удалены все их записи в базе данных. Вы уверены, что хотите продолжить?',
                    'confirm' => 'Удалить пользователей',
                    'cancel' => 'Отмена',
                ],
            ],
        ],
